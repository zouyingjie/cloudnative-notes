...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-2-用户" tabindex="-1"><a class="header-anchor" href="#_2-2-用户" aria-hidden="true">#</a> 2.2 用户</h4><p>Kubernetes 虽然有用户的概念，但它认为用户是由集群无关的服务进行管理的，因此并没有提供类似 kubectl create user 的 API 来创建用户。</p><p>当外部访问 apiserver 时，Kubernetes 可以使用的认证方式有：</p>`,34)),s("ul",null,[n[3]||(n[3]=s("li",null,"客户端证书认证",-1)),n[4]||(n[4]=s("li",null,"静态的用户密码或 token 文件（Departed）",-1)),n[5]||(n[5]=s("li",null,"Bootstrap tokens",-1)),s("li",null,[s("a",r,[n[0]||(n[0]=a("OpenID Connect (OIDC)")),t(e)])]),s("li",null,[s("a",d,[n[1]||(n[1]=a("Authenticating proxy")),t(e)])]),s("li",null,[s("a",k,[n[2]||(n[2]=a("Webhook token authentication")),t(e)])])]),s("p",null,[n[7]||(n[7]=a("这里比较常用的方式是客户端证书，其他方式使用可以参考这份索引 ")),s("a",v,[n[6]||(n[6]=a("文档")),t(e)]),n[8]||(n[8]=a("。"))]),n[36]||(n[36]=p(`<p>Kubernetes 内置了 <code>Certificate Signing Request</code> 对象来执行证书签名。当外部用户想请求 Kubernetes 时，可以使用私钥来生成 CSR 证书签名请求，然后交给 Kuberetes 签发。流程如下</p><h5 id="生成私钥与-csr" tabindex="-1"><a class="header-anchor" href="#生成私钥与-csr" aria-hidden="true">#</a> 生成私钥与 CSR</h5><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建私钥</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Kubeconfig 文件可以分为三部分：</p><ul><li><strong>Clusters</strong>：要访问的集群，指定集群名称、访问地址以及 CA 证书。</li><li><strong>Users</strong>： 用户信息，指定用户名以及私钥、证书作为访问凭证。</li><li><strong>Contexts</strong>：访问上下文，指定用哪个用户访问哪个集群。</li></ul><p><img src="https://i-blog.csdnimg.cn/blog_migrate/e391b7298278647cdee8b4ef3e6be96a.png" alt="在这里插入图片描述"></p><p>通过添加不同的集群和用户，并设置不同的上下文，我们就可以在同一个终端对不同的集群进行访问。</p><p>除了直接修改文件外我们可以通过 kubectl config 命令来动态操作 kubeconfig 配置。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ kubectl config
...
place.
  <span class="token number">2</span>.  If <span class="token variable">$KUBECONFIG</span> environment variable is set, <span class="token keyword">then</span> it is used as a list of paths <span class="token punctuation">(</span>normal path delimiting rules <span class="token keyword">for</span>
...
last <span class="token function">file</span> <span class="token keyword">in</span> the list.
  <span class="token number">3</span>.  Otherwise, <span class="token variable">\${<span class="token environment constant">HOME</span>}</span>/.kube/config is used and no merging takes place.
...
<span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> my<span class="token punctuation">-</span>webhook.example.com
  ...
  <span class="token punctuation">...</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>namespaceSelector</strong></p>`,15)),s("p",null,[n[20]||(n[20]=a("匹配命名空间，根据资源对象所在的命名空间作拦截，下面是 ")),s("a",g,[n[19]||(n[19]=a("EaseMesh")),t(e)]),n[21]||(n[21]=a(" 的示例， 针对带有 ")),n[22]||(n[22]=s("code",null,"mesh.megaease.com/mesh-service",-1)),n[23]||(n[23]=a(" 标签的，除 easemesh、kube-system、kube-public 之外的命名空间中的对象，如果对象符合 rules 中的定义，则会将请求发送到 webhook server。"))]),n[39]||(n[39]=p(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> admissionregistration.k8s.io/v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> MutatingWebhookConfiguration
<span class="token punctuation">...</span>
<span class="token key atrule">webhooks</span><span class="token punctuation">:</span>
...
<span class="token punctuation">..</span>.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i-blog.csdnimg.cn/blog_migrate/49120e9723d1a2064896616def00cb0e.png" alt="在这里插入图片描述"></p><p>像 Kubernetes 的控制平面组件 kube-apiserver 等都是设置了该选项，从而使得它们的行为与不在 Pod 中运行时相同。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ kubectl get pods <span class="token parameter variable">-n</span> kube-system kube-apiserver-vm-0-7-ubuntu <span class="token parameter variable">-o</span> yaml
apiVersion: v1
kind: Pod
metadata:
...
<span class="token key atrule">spec</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> Ingress
  <span class="token punctuation">-</span> Egress
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后需要注意的是 Network Policy 的功能是由网络插件实现的，因此是否可以使用该特性取决于我们使用的网络插件。像 Calico、Weave 都对该功能做了支持，但 Flannel 本身不支持，需要结合 Calico 使用才性能，参考文档 Installing Calico for policy and flannel (aka Canal) for networking。</p><p>以上是对 Kubernetes 安全相关的简单概述，在实际云原生环境里，其安全性按层分需要从所谓的 4C（Cloud, Clusters, Containers, and Code.）四个层面来保证。Kubernetes 只是其中的一层而已。</p><p><img src="https://i-blog.csdnimg.cn/blog_migrate/f14dc24b85627ce5fa32bf015b08938f.png" alt="在这里插入图片描述"></p>`,45))])}const S=l(u,[["render",V],["__file","08.security.html.vue"]]);export{S as default};
